...
const routes: Routes = [
  ...
  // tslint:disable-next-line:max-line-length
  { path: 'add-payment-method/:page', loadChildren: './user-payment-method/add-payment-method/add-payment-method.module#AddPaymentMethodPageModule', canActivate: [AuthGuardService] },
  // tslint:disable-next-line:max-line-length
  { path: 'show-payment-method/:page', loadChildren: './user-payment-method/show-payment-method/show-payment-method.module#ShowPaymentMethodPageModule', canActivate: [AuthGuardService] },
    // tslint:disable-next-line:max-line-length
    { path: 'campaigns/:page', loadChildren: './campaigns/show-campaigns-list/show-campaigns-list.module#ShowCampaignsListPageModule', canActivate: [AuthGuardService] },
    // tslint:disable-next-line:max-line-length
