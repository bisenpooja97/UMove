...
const routes = [
    ...
    { path: 'report', loadChildren: () => Promise.all(/*! import() | report-report-module */[__webpack_require__.e("default~dashboard-dashboard-module~report-report-module"), __webpack_require__.e("report-report-module")]).then(__webpack_require__.bind(null, /*! ./report/report.module */ "./src/app/report/report.module.ts")).then(m => m.ReportModule) },
...
let ZonesComponent = class ZonesComponent {
    constructor(zoneService, matDialog, notificationService, location) {
        this.zoneService = zoneService;
        this.matDialog = matDialog;
        this.notificationService = notificationService;
        this.location = location;
