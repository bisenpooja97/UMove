...
var AddUserComponent = /** @class */ (function () {
    function AddUserComponent(fb, userService, dialogRef, data) {
        ...
        this.userForm = this.fb.group({
            ...
            mobileNumber: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern('[a-zA-z]+')]],
            email: ['', []],
            role: ['', []],
...
var DocumentApprovalComponent = /** @class */ (function () {
    function DocumentApprovalComponent(router, userservice) {
        this.router = router;
        this.userservice = userservice;
    }
    DocumentApprovalComponent.prototype.ngOnInit = function () {
    ...
    DocumentApprovalComponent.prototype.ok = function () {
        console.log('ok', this.id);
        this.router.navigate(['users/document', this.id]);
    };
    DocumentApprovalComponent.ctorParameters = function () { return [
    ...
    return DocumentApprovalComponent;
}());
...
module.exports = ".my-card {\n    margin-bottom: 40px;\n    height: 250px;\n    background-color:antiquewhite;\n    cursor: pointer;\n}\n\n.my-card:hover {\n    transform: scale(1.1);\n}\n\n.name {\n    padding-top: 10%;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
