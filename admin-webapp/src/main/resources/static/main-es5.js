...
module.exports = "<mat-card (click)=\"ok()\" class=\"my-card\">\n      <mat-card-content fxLayoutAlign=\"center center\" >\n                <img mat-card-image src=\"{{url}}\" [lazyLoad]=\"url\">\n        </mat-card-content>\n    <mat-card-title  class=\"typeName font-style\">{{name}}</mat-card-title>\n    <mat-card-content class=\"font-style\">Cost/km : {{costPerKm | number: '1.2-2'}}</mat-card-content>\n    <mat-card-content class=\"font-style\">Cost/min :{{costPerMin | number: '1.2-2'}}</mat-card-content>\n</mat-card>\n"
...
module.exports = "<mat-card (click)=\"ok()\" class=\"my-card\">\n\n    <mat-card-content fxLayoutAlign=\"space-between\" >\n            <ngx-avatar class=\"font-style\" name=\"{{locality}}\"></ngx-avatar>\n            <mat-chip-list aria-label=\"Fish selection\">\n        <mat-chip [ngStyle]=\"{'background-color':getColor(status)}\" class=\"status font-style\">{{status}}</mat-chip>\n        </mat-chip-list>\n    </mat-card-content>\n    <mat-card-title class=\"zoneName font-style\">{{zoneNames}}</mat-card-title>\n    <mat-card-content class=\"font-style\">{{city}}</mat-card-content>\n    <mat-card-content class=\"font-style\">Total Vehicle Capacity: {{capacity}}</mat-card-content>\n    <mat-card-content class=\"font-style\">Current Vehicle Capacity: {{count}}</mat-card-content>\n</mat-card>\n"
...
var SettingsComponent = /** @class */ (function () {
    ...
    SettingsComponent.prototype.onTimeChange = function (name, value) {
        var _this = this;
        this.settingsService.updateConfigurationByName(name, value).subscribe(function (response) {
            _this.notificationService.success('Time Updated successfully!!');
            console.log('Response of updated time: ', response);
        }, function (error) {
            if (error.status === 400) {
                _this.notificationService.warn('Time cannot be Updated!!');
            }
        });
    };
...
module.exports = "mat-toolbar {\n  background-color: white;\n}\n\ncontroles-container{\n  width: 100%;\n  padding: 5%;    \n}\n\n.fill-remaining-space {\n  /* This fills the remaining space, by using flexbox. \n     Every toolbar row uses a flexbox row layout. */\n  flex: 1 1 auto;\n}\n\n.controles-container > * {\n  width: 100%;\n  }\n\n.btn {\n  width: 16em; height: 60px;\n }\n\n.btn-dialog-close{\n  width: 45px;\n  min-width: 0px !important;\n  height: 40px;\n  padding: 0px !important;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".vehicleName {\n    margin-left: 240px;\n    padding-bottom: 2%;\n}\n\n.graph {\n    margin-top: 20px;\n    padding-left: 850px;\n    cursor: pointer;\n}\n\n.type {\n    margin-bottom: 40px;\n    margin-left: 450px;\n    height: 300px;\n    width: 50%;\n}\n\n.space-top {\n    padding-top: 10%;\n    padding-bottom: 12%;\n}\n\n.iconCapacity {\n    \n    cursor: pointer;\n}\n\n@media only screen and (max-width: 600px) {\n    .type {\n        margin-left: 30px;\n        height: 300px;\n        width: 85%;\n    }\n    .vehicleName {\n        margin-left: 50px;\n        font-size: 1.5em;\n        padding-bottom: 5px;\n    }\n}\n\n.add-button {\n    padding-right: 450px;\n    padding-bottom: 2%;\n}\n\nmat-icon {\n    font-size: 60px;\n}\n\n.icon {\n    margin-left: 80%;\n    cursor: pointer;\n}\n\n.status {\n    margin-top: 20px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".typeName {\n    padding-top: 20px;\n}\n.status {\n    font-weight: bold;\n    font-size: 1em;\n    color: white;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".vehicleName {\n    margin-left: 240px;\n    padding-bottom: 2%;\n    padding-right: 750px;\n}\n\n.date {\n    font-size: 1.3em;\n}\n\n.graph {\n    margin-top: 20px;\n    padding-left: 850px;\n    cursor: pointer;\n}\n\n.space-top {\n    padding-top: 10%;\n    padding-bottom: 10%;\n}\n\n@media only screen and (max-width: 600px) {\n    .vehicle {\n        margin-left: 30px;\n        height: 300px;\n        width: 85%;\n    }\n    .vehicleName {\n        margin-left: 50px;\n        font-size: 1.4em;\n        padding-bottom: 5px;\n    }\n    .status {\n            margin-top: 20px;\n            padding-right: 60px;\n           \n        }\n        .icon {\n            margin-left: 20%;\n        }\n\n        .date {\n            font-size: 1em;\n        }\n}\n\n@media only screen and (min-width: 600px) {\n    .icon {\n        margin-left: 70%;\n        background-color:transparent;\n        }   \n\n        .vehicle {\n            margin-bottom: 40px;\n            margin-left: 450px;\n            height: 350px;\n            width: 50%;\n        }\n        \n        \n}\n\n.status {\n    margin-top: 20px;\n    padding-left: 60px;\n    font-weight: bold;\n    font-size: 1em;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
