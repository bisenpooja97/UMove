...
var SettingsService = /** @class */ (function () {
    ...
    SettingsService.prototype.getConfigurationByName = function (name) {
        return this.httpClient.get(this.baseUrl + '/' + name);
    };
    SettingsService.prototype.updateConfigurationByName = function (name) {
...
var SettingsComponent = /** @class */ (function () {
    ...
    SettingsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.settingsService.getConfigurationByName('autocancelTime').subscribe(function (response) {
            console.log('Response of autocancel time value: ', response);
            _this.autocancelTimeValue = response.value;
        });
    };
