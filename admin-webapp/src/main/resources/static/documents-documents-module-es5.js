...
var DocumentsService = /** @class */ (function () {
    ...
    DocumentsService.prototype.sendNotificationForKycApproval = function (userId, status) {
        var body = {
            "notification": {
                "title": "UMove",
        ...
        var options = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]().set('Content-Type', 'application/json');
