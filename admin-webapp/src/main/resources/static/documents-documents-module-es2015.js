...
let DocumentCardComponent = class DocumentCardComponent {
    constructor(router, matDialog, documentService, notificationService) {
        this.router = router;
    ...
    view() {
        const dRef = this.matDialog.open(_update_kyc_update_kyc_component__WEBPACK_IMPORTED_MODULE_3__["UpdateKycComponent"], {
            width: '40vw',
            disableClose: true,
            autoFocus: true,
            data: {
...
module.exports = ".header {\n    margin-left: 240px;\n}\n\napp-user-card {\n    \n    width: 25%;\n    margin-left: 50px;\n    \n}\n\n.card {\n    margin-left: 18%;\n}\n\n.search {\n    margin-left: 240px;\n    margin-bottom: 50px;\n}\n\n@media only screen and (max-width: 600px) {\n    .card {\n        margin-left: 10%;\n    }\n\n    app-user-card {\n        width: 75%;\n    }\n    \n    .search {\n        margin-left: 60px;\n        margin-bottom: 50px;\n    }\n\n    .header {\n        margin-left: 50px;\n    }\n}\n\n.no-data {\n    padding-bottom: 20%;\n    padding-top: 18%;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
let DocumentsComponent = class DocumentsComponent {
    constructor(documentService, notificationService, matDialog) {
        this.documentService = documentService;
        this.notificationService = notificationService;
        this.matDialog = matDialog;
...
let DocumentsService = class DocumentsService {
    ...
    sendNotificationForKycApproval(userId, status) {
        ...
        let options = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]().set('Content-Type', 'application/json');
...
let UpdateKycComponent = class UpdateKycComponent {
    constructor(dialogRef, data, documentService, notificationService) {
