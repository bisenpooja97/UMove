...
var VehiclesComponent = /** @class */ (function () {
    ...
    VehiclesComponent.prototype.ngOnInit = function () {
        ...
        return this.vehicleService.getVehicles().subscribe(function (res) { return _this.dataSource.data = res.data; }, function (length) { return _this.dataSource.data.length = length; });
    };
    VehiclesComponent.prototype.ngAfterViewInit = function () {
