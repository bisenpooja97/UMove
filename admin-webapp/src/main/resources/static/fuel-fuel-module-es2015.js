...
let AddFuelComponent = class AddFuelComponent {
    constructor(dialogRef, fb, route, router, fuelService, snackBar) {
...
let FuelDetailsComponent = class FuelDetailsComponent {
    constructor(router, fuelService, activatedRoute, route, snackbar, matDialog) {
        this.router = router;
        this.fuelService = fuelService;
...
let FuelComponent = class FuelComponent {
    constructor(fuelService, matDialog, snackBar) {
        this.fuelService = fuelService;
        this.matDialog = matDialog;
        this.snackBar = snackBar;
        this.p = 1;
    ...
    ngOnInit() {
        ...
        return this.fuelService.getFuel().subscribe(res => this.dataSource.data = res.data, length => this.dataSource.data.length = length);
    }
    ngAfterViewInit() {
...
let UpdateFuelComponent = class UpdateFuelComponent {
    constructor(dialogRef, fb, route, router, fuelService, data) {
        this.dialogRef = dialogRef;
        this.fb = fb;
        this.route = route;
        this.router = router;
