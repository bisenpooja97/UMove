...
var FuelComponent = /** @class */ (function () {
    ...
    FuelComponent.prototype.ngOnInit = function () {
        ...
        return this.fuelService.getFuel().subscribe(function (res) { return _this.dataSource.data = res.data; }, function (length) { return _this.dataSource.data.length = length; });
    };
