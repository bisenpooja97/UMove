...
let CountDisplayComponent = class CountDisplayComponent {
    constructor(zoneService, vehicleService, vehicleTypeService, userService) {
...
CountDisplayComponent.ctorParameters = () => [
...
let DashboardComponent = class DashboardComponent {
    ...
    getBarData() {
        this.dashboardService.getVehicleByStatus('Busy').subscribe(res => {
            this.busy = res.count;
            this.barCount.push(res.count);
            this.barLabel.push('Busy');
        });
        this.dashboardService.getVehicleByStatus('No_More_In_Use').subscribe(res => {
            this.noMoreInUse = res.count;
            this.barCount.push(res.count);
            this.barLabel.push('No_More_In_Use');
        });
        this.dashboardService.getVehicleByStatus('Stolen').subscribe(res => {
            this.stolen = res.count;
            this.barCount.push(res.count);
            this.barLabel.push('Stolen');
        });
        this.dashboardService.getVehicleByStatus('Free').subscribe(res => {
            this.free = res.count;
            this.barCount.push(res.count);
            this.barLabel.push('Free');
        });
        this.dashboardService.getVehicleByStatus('Servicing').subscribe(res => {
            this.servicing = res.count;
            this.barCount.push(res.count);
            this.barLabel.push('Servicing');
        });
    }
    getPieData() {
        this.dashboardService.getZoneByStatus('ACTIVE').subscribe(res => {
            this.pieCount.push(res.count);
            this.pieLabel.push('Active');
        });
        this.dashboardService.getZoneByStatus('INACTIVE').subscribe(res => {
            this.pieCount.push(res.count);
            this.pieLabel.push('InActive');
        });
        this.dashboardService.getZoneByStatus('FULL').subscribe(res => {
            this.pieCount.push(res.count);
            this.pieLabel.push('Full');
        });
        this.dashboardService.getZoneByStatus('INMAINTAINANCE').subscribe(res => {
            this.pieCount.push(res.count);
